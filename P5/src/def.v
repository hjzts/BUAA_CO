...
`define CU_ALU_SHAMT_SEL_16     3'b000
`define CU_ALU_SHAMT_SEL_SA     3'b001

`define CU_GRF_A3_WA_RT         2'b00
`define CU_GRF_A3_WA_RD         2'b01
`define CU_GRF_A3_WA_RA_31      2'b10
   
`define CU_GRF_WD_ALU_RESULT    2'b00
`define CU_GRF_WD_DM_RD         2'b01
`define CU_GRF_WD_PC4           2'b10   
//***********H U***********//
//***********B E***********//
`define BE_SW                   3'b000
`define BE_SH                   3'b001
...
`define CMP_SIGNED_GREETER            4'b0110
`define CMP_SIGNED_GREETWER_OR_EQUAL  4'b0111
`define CMP_UNSIGNED_GREETER          4'b1000
`define CMP_UNSIGNED_GREETWE_OR_EQUAL 4'b1001
//***********DE_REG***********//
